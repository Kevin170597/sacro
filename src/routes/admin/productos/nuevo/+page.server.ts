...
export const load: PageServerLoad = async () => {
    ...
    let defaultVariant = {
        ...
        images: [
            ...
            {
                id: nanoid(5),
                url: "https://t3.ftcdn.net/jpg/09/16/82/78/360_F_916827828_bBwwvn5wz8aycMlTw6K4fXQY4IkiOl2Q.jpg"
            },
            { 
                id: nanoid(5),
                url: "https://pixlr.com/images/generator/text-to-image.webp"
            }
        ],
        size: [{ id: "1", name: "XS" }]
    };
...
export const actions: Actions = {
    default: async ({ request }) => {
        ...
        console.log(form.data.variants[0].images)
        if (!form.valid) {
